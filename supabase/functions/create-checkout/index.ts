  ...
  try {
    ...
    const planPricing = {
      standard: {
        price: 1999, // $19.99
        name: "Plan Standard",
        description: "Jusqu'à 10 propriétés, rapports avancés, support prioritaire"
      },
      pro: {
        price: 4999, // $49.99
        name: "Plan Pro", 
        description: "Propriétés illimitées, tous les rapports, support dédié"
      }
    };

    if (!planPricing[plan as keyof typeof planPricing]) {
