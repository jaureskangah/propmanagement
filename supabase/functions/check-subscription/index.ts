...
serve(async (req) => {
  ...
  try {
    ...
    if (hasActiveSub) {
      ...
      logStep("Determining subscription tier", { priceId });
      
      // Détermine le tier selon le price ID
      if (priceId === "price_1RpmiqBQGq0kS1iiOLKab9L6") {
        subscriptionTier = "standard";
      } else if (priceId === "price_1RpmhGBQGq0kS1iieBEcFUE9") {
        subscriptionTier = "pro";
      } else {
        subscriptionTier = "standard"; // fallback
      }
