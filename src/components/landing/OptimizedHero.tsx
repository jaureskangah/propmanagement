        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-8 py-6 transform hover:scale-105"
            >
              {t('heroGetStarted')}
            </Button>
