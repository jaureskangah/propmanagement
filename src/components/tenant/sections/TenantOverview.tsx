...
export const TenantOverview = ({
  ...
  const getLeaseStatusColor = () => {
    switch (leaseStatus.status) {
      case 'expired': return 'bg-red-500/10 text-red-700 border-red-200 dark:bg-red-500/20 dark:text-red-400 dark:border-red-800';
      case 'expiring': return 'bg-orange-500/10 text-orange-700 border-orange-200 dark:bg-orange-500/20 dark:text-orange-400 dark:border-orange-800';
      default: return 'bg-green-500/10 text-green-700 border-green-200 dark:bg-green-500/20 dark:text-green-400 dark:border-green-800';
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-card to-card/50 dark:from-card dark:to-card/80">
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-card to-card/50 dark:from-card dark:to-card/80">
            ...
            <CardContent className="relative">
              <div className="flex items-center justify-between">
                <span className="text-2xl font-bold text-card-foreground">{pendingRequests}</span>
      ...
      >
        <Card className="border-0 shadow-lg bg-gradient-to-br from-card to-card/50 dark:from-card dark:to-card/80">
          <CardHeader>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              {maintenanceRequests.slice(0, 3).map((request, index) => (
                <div key={request.id} className="flex items-center gap-3 p-3 bg-card/50 dark:bg-card/80 rounded-lg border border-border">
