  ...
  const metrics = [
    {
      ...
      description: t('totalRequestsDesc') // Utiliser la nouvelle description traduite
    },
    {
      ...
      description: t('pendingRequestsDesc') // Utiliser la nouvelle description traduite
    },
    {
      ...
      description: t('resolvedRequestsDesc') // Utiliser la nouvelle description traduite
    },
  ];
          ...
          >
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="text-2xl font-bold transition-all duration-300 group-hover:translate-x-1 animate-fade-in">{metric.value}</div>
