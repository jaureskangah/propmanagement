...
export function ModernMetricCard({
  ...
  const getGradientStyles = () => {
    ...
    } else if (chartColor === '#8B5CF6') {
      return {
        bgGradient: "from-purple-50 via-violet-50 to-indigo-50 dark:from-purple-900/30 dark:via-violet-900/20 dark:to-indigo-900/10",
        borderColor: "border-purple-200/60 dark:border-purple-700/40",
        hoverBorder: "hover:border-purple-300/80 dark:hover:border-purple-600/60",
