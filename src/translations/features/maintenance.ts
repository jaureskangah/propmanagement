...
export const enMaintenance = {
  ...
  reminderViaApp: "In App",
  reminderViaEmail: "Email",
  reminderViaBoth: "Both",
...
export const frMaintenance = {
  ...
  reminderViaApp: "Dans l'app",
  reminderViaEmail: "Email",
  reminderViaBoth: "Les deux",
