...
export const enFinances = {
  // Main sections
  finances: "Finances",
  financesManagement: "Financial Management",
  ...
  profitableProperty: "Profitable Property",
...
export const frFinances = {
  ...
  finances: "Finances",
  financesManagement: "Gestion Financière",
  ...
  profitableProperty: "Propriété Profitable",
  ...
  // Export et actions
  exportFinancialReport: "Exporter le Rapport Financier",
