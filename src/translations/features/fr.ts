...
import { frList } from './tenant/fr/list';
import { frPayments } from './tenant/fr/payments';
...
export const fr = {
  ...
  manageInvitationsSentToTenants: "Gérez les invitations envoyées aux locataires",
  invitation: "invitation",
  invitations_plural: "invitations",
  refresh: "Actualiser",
  allInvitations: "Toutes",
  pendingInvitations: "En attente",
  expiredInvitations: "Expirées",
  acceptedInvitations: "Acceptées",
  cancelledInvitations: "Annulées",
  noInvitation: "Aucune invitation",
  noInvitationInCategory: "Aucune invitation dans cette catégorie pour le moment",
