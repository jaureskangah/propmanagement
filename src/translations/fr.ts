...
const translations = {
  ...
  step1Description: "Inscrivez-vous en quelques minutes avec votre adresse e-mail",
  ...
  step4Description: "Surveillez la maintenance, les paiements et les documents en un endroit",
  ...
  faqSecurityAnswer: "Oui, nous utilisons un chiffrement standard et des mesures de sécurité pour protéger vos données.",
  ...
  manageApartmentInfo: "Gérez les informations de votre appartement et les communications",
  ...
  unpaidRentDescription: "Paiements de loyer en suspens",
  ...
  noPreviewAvailable: "Aucun aperçu disponible pour le moment",
  ...
  saveProperty: "Sauvegarder la Propriété",
